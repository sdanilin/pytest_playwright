...
def run(playwright: Playwright) -> None:
    ...
    # Click text=39 hello world alice Norun None PASS FAIL Details Delete >> button >> nth=3
    page.locator("text=39 hello world alice Norun None PASS FAIL Details Delete >> button").nth(3).click()
